...
- **Monte Carlo** probability of success (500 runs, configurable σ, normal distribution clamped at -55%)
...
| Equity expected return (μ) | 12% p.a. | Nifty 50 ~20-yr CAGR |
| Equity volatility (σ) | 18% p.a. | Nifty 50 historical |
